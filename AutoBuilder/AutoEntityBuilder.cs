...
internal class AutoEntityBuilder : IIncrementalGenerator
{
    ...
    private void Execute(SourceProductionContext context, (Compilation compilation, ImmutableArray<ClassDeclarationSyntax> classes) tuple)
    {
        ...
        {
            GenerateBuilderClass(context, compilation, syntax);
        }
    }
    
    private static void GenerateBuilderClass(SourceProductionContext context, Compilation compilation, ClassDeclarationSyntax syntax)
    {
